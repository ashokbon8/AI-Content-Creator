        ...
        <div className="relative z-10 mx-auto max-w-3xl">
          ...
          <TypewriterEffect
            words={[
              ...
              { text: "smarter." },
              { text: "Create" },
              { text: "better.", className: "text-teal-500" },
            ]}
          ...
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            <a
              href="/sign-up"
              className="rounded-xl bg-teal-600 px-8 py-3 text-base font-semibold text-white shadow-md transition hover:bg-teal-500"
            >
              Get Started Free
            </a>
            <a
