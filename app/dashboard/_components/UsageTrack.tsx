  ...
  return (
    <div className='p-5'>
      <div className='bg-primary text-white p-3 rounded-lg'>
        ...
        <div className='h-2 bg-teal-500 w-full rounded-full mt-3'>
      ...
      <Button variant={'secondary'} className='text-primary w-full my-3 hover:bg-teal-50/10 transition-colors'>Upgrade Plan</Button>
    </div>
  )
}
