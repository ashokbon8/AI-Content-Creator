    ...
    <div className="min-h-screen bg-[#0D131F] text-white p-8">
      <div className="max-w-4xl mx-auto rounded-2xl bg-black/30 backdrop-blur-lg p-8">
        <div className="flex items-center justify-center mb-8">
          <Sparkles className="w-8 h-8 mr-2 text-[#0d9488]" />
          ...
          <div className="flex flex-col items-center space-y-4">
            <div className="relative">
              <Image
                ...
                className="w-20 h-20 rounded-full ring-4 ring-[#0d9488] transition-transform duration-300 hover:scale-110"
                width={200}
                height={200}
              />
          ...
          <div className="space-y-4">
            <div className="flex flex-wrap gap-2 justify-center">
              {currentTestimonial.techStack.map((tech) => (
                <div
                  key={tech}
                  className="px-3 py-1 rounded-full bg-[#0d9488] border border-[#0d9488] cursor-pointer
                           transition-all duration-300 hover:bg-[#0f766e] hover:scale-105"
        ...
        <div className="flex justify-center space-x-4 mt-8">
          <button
            ...
            className="p-3 rounded-full bg-[#0d9488] hover:bg-[#0f766e] transition-colors duration-300"
          >
            <ArrowLeft/>
          </button>
